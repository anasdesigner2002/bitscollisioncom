...
import serviceData from "@/content/pages/pipzero.json";
import styles from "./ServiceDetail.module.css";

export const metadata: Metadata = {
  title: "Pipzero Details – Bits Collision – IT Solutions & Technology, Business Consulting, Software Company",
...
export default function DigitalStrategyMarketingPage() {
  ...
  return (
    <main>
       <PageBreadcrumb title="PIPZERO" current="Pipzero" />
