...
import serviceData from "@/content/pages/giftee.json";
import styles from "./ServiceDetail.module.css";

export const metadata: Metadata = {
  title: "Giftee Details – Bits Collision – IT Solutions & Technology, Business Consulting, Software Company",
...
export default function DigitalStrategyMarketingPage() {
  ...
  return (
    <main>
       <PageBreadcrumb title="GIFTEE" current="Giftee" />
