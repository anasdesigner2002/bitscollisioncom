...
import serviceData from "@/content/pages/odentika.json";
import styles from "./ServiceDetail.module.css";

export const metadata: Metadata = {
  title: "Odentika Details – Bits Collision – IT Solutions & Technology, Business Consulting, Software Company",
...
export default function DigitalStrategyMarketingPage() {
  ...
  return (
    <main>
       <PageBreadcrumb title="ODENTIKA" current="Odentika" />
