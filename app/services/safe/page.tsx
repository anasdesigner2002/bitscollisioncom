...
import serviceData from "@/content/pages/safe.json";
import styles from "./ServiceDetail.module.css";

export const metadata: Metadata = {
  title: "Safe Details – Bits Collision – IT Solutions & Technology, Business Consulting, Software Company",
...
export default function DigitalStrategyMarketingPage() {
  ...
  return (
    <main>
       <PageBreadcrumb title="SAFE" current="Safe" />
