...
import serviceData from "@/content/pages/pleromi.json";
import styles from "./ServiceDetail.module.css";

export const metadata: Metadata = {
  title: "Pleromi Details – Bits Collision – IT Solutions & Technology, Business Consulting, Software Company",
...
export default function DigitalStrategyMarketingPage() {
  ...
  return (
    <main>
       <PageBreadcrumb title="PLEROMI" current="Pleromi" />
